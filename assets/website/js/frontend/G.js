        ...
        init: function (page_code) {
			switch(page_code)
			{
				...
				case 'newly_discovered_nodes':
					...
					for(var i=0;i<5;i++)
					{
						var clash_url = 'https://luostsensai.github.io/uploads/'+dateItems['year']+'/'+dateItems['month']+'/'+i+'-'+dateItems['year']+dateItems['month']+dateItems['day']+'.yaml';
						clash_rows.push(clash_url);

						var v2ray_url = 'https://luostsensai.github.io/uploads/'+dateItems['year']+'/'+dateItems['month']+'/'+i+'-'+dateItems['year']+dateItems['month']+dateItems['day']+'.txt';
						v2ray_rows.push(v2ray_url);
					}
					var singbox_rows = ['https://luostsensai.github.io/uploads/'+dateItems['year']+'/'+dateItems['month']+'/'+dateItems['year']+dateItems['month']+dateItems['day']+'.json'];
